...
with(dat, plot(time_series, Global_active_power, type="l", xlab="", ylab="Global Active Power"))

with(dat, plot(time_series, Voltage, type="l", xlab="datetime", ylab="Voltage"))
...
with(dat, plot(time_series, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
